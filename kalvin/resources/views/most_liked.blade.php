...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  	<title>@if(auth()->check()) {{ auth()->user()->fname }} | SDUG @else Most liked SDUG Memes @endif</title>
        ...
        <i class="fa fa-bars" id="these_bars" style="color: white;"></i>
          ...
          <div class="collapse navbar-collapse" id="navbar-default">
              ...
              <ul class="navbar-nav"  style="">
                  ...
                  <li class="nav-item active"  data-nav="new" >
                      <a class="nav-link nav-link-icon" href="#">
...
<div class="main_head">
 <div class="container">
  <div class="row">
     <div class="col-lg-12">
            <h4 class="text-center" style="padding-top: 30px;">Most Liked </h4>
