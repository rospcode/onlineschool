...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Contact | CapabilityHR</title>
...
.sow-icon-linearicons[data-sow-icon]::before {
...
.artdeco-button__icon:hover{
cursor: pointer;
background-color: white;
}

.artdeco-button__iconi{
  background-color: #ebebeb;
  padding: 16px;
  border-radius: 50%;
  position: relative;
...
<body>
    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item about_c">
            <a href="/aboutus" class="nav-link">
              <span class="nav-link-inner--text">ABOUT US</span>
            </a>
          </li>
          <li class="nav-item solutins_c">
          ...
          <li class="nav-item gallery_c">
            <a href="/gallery" class="nav-link">
              <span class="nav-link-inner--text"> GALLERY</span>
            </a>
          </li>
          <li class="nav-item contact_c">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-primary" style="padding-bottom: 2rem !important; padding-top: 6rem !important; background-image: url({{ asset('images/CapabilityBPOback.jpg') }});
background-repeat: no-repeat;
background-size: cover;
...
position: relative;">
      <div class="container">
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                <h2 class="display-2 text-white font-weight-bold mb-0">Contact Us</h2>
                <p class="lead" style="color: white; font-weight: 500;">Home / Contact</p>
              </div>
            </div>
            <div class="col-lg-6">
            </div>
    ...
    <section class="py-6" style="background-color: white; padding-bottom: 2rem !important;">
      <div class="container">
                    <div class="row">
                      <div class="col-lg-12">
                         <h2 class="text-center">CONTACT US</h2>

                         <p class="text-center" style="text-transform: uppercase;">Connect with us, Leave us a message below and<br/> we will reply as soon as possible</p>
                      ...
                      <div class="col-lg-6" style="padding-top: 80px;">
                        <h3>CONTACT INFO</h3>
                        <p>You can reach us by email and contact number listed below. alternatively send us an email using our form.</p>


                        <div class="row">
                           <div class="col-lg-1">
                                      <i class="fa fa-phone" style="width: 55px;font-size: 20px;height: 55px;line-height: 55px;border-radius: 50%;border: 1px dashed #0c1832;text-align: center;margin-right: 20px;"></i>
                           </div>
                           <div class="col-lg-11">
                             <abbr style="padding-left: 20px;padding-top: 20px;position: relative;top: 15px;">+27 61 381 7089</abbr>
                           </div>
                           <div class="col-lg-1" style="padding-top: 20px;">
                                    <i class="far fa-envelope-open" style="width: 55px;font-size: 20px;height: 55px;line-height: 55px;border-radius: 50%;border: 1px dashed #0c1832;text-align: center;margin-right: 20px;"></i>
                           </div>
                           <div class="col-lg-11" style="padding-top: 20px;">
                             <abbr style="padding-left: 20px;padding-top: 20px;position: relative;top: 15px;">info@capabilityhr.com</abbr>
                           </div>
                           <div class="col-lg-1" style="padding-top: 20px;">
                                      <i class="fas fa-map-marker-alt" style="width: 55px;font-size: 20px;height: 55px;line-height: 55px;border-radius: 50%;border: 1px dashed #0c1832;text-align: center;margin-right: 20px;"></i>
                           </div>
                           <div class="col-lg-11" style="padding-top: 20px;">
                             <abbr style="padding-left: 20px;padding-top: 20px;position: relative;top: 15px;">303 Dr pixley street, durban 4000</abbr>
                           </div>
                         </div>
                        ...
                        <form method="post" action="{{ route('contact.sendemail')}}">
                          ...
                          <div class="row">
                              ...
                              <label for="message">Message:</label>
                                <textarea name="message" class="form-control" rows="7" style="width: 540px;">
                                </textarea>
                               </div>
                              </div>
                          ...
                          @endif
                              ...
                              <div class="col-lg-12">
                               <div class="form-group">
                               <button type="submit" id="sendmail" class="btn btn-success btn-block">Send</button>
                               </div>
                              </div>
  ...
  $(function(){
    $("#submit_subscribe").click(function(ev){
      ev.preventDefault();
      let email_m = $("#email_subscribe").val();
      if(email_m){
        $.ajax({
          type: "POST",
          url: "/subscribe",
          data: {email_m: email_m},
  ...
  $(".more").click(function(ev){
    ev.preventDefault();
      $("#add").html(" for the purpose of sending me training related material and industry information in their newsletters and articles and am aware I can unsubscribe at any time.");
      $(".more").hide();
  })
  </script>
