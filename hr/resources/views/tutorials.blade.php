...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Tutorials | CapabilityHR</title>
...
<body>
  ...
  <!-- Navabr -->
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-main navbar-expand-lg navbar-dark" style="padding: .358rem .1343234rem; background-color: #0c1832;">
    <div class="container">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-primary" style="padding-bottom: 2rem !important;
...
background-attachment: fixed;">
      <div class="container">
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                <h2 class="display-2 text-white font-weight-bold mb-0">Blog Posts</h2>
                <p class="lead" style="color: white; font-weight: 500;">Home / Blog</p>
              </div>
            </div>
            <div class="col-lg-6">
            </div>
    ...
    <section class="py-7" style="padding-top: 4rem !important; padding-bottom: 2rem !important;">
           <div class="container">
             <div class="row">
...
@endforeach
  ...
  <footer id="footer" class="footer-section footer-dark-section">
      ...
      <div style="background-color: #1a8fcb; padding: 7px;"><p class="text-center" style="color:white; margin-bottom: 0rem;font-size: 1rem;font-weight: 400;">Copyright and Allrights reserve © <script type="text/javascript">document.write(new Date().getFullYear());</script></p></div>
