                    ...
                    <div class="topic1 hero-bg">
                        <div uk-grid>
                            ...
                            <div class="uk-width-1-2@m uk-visible@m">
                                <img src="<?php echo e(asset('assets/images/courses/course-catagory-hero-1.jpg')); ?>" alt="" class="uk-align-right img-xxlarge">
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="uk-container">
                        ...
                        <div class="uk-child-width-1-2@s uk-child-width-1-3@m uk-grid-match uk-margin" uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > div ; delay: 200" uk-grid>
                            ...
                            <?php if($course->course_status != "Down"): ?>
                               <!-- Course   -->
                            <div>
...
<?php echo substr($course->course_title, 0,30); ?>..
                                                             ...
                                                             <p><?php if(strlen($course->course_notes) > '150'): ?>
                                                                 <?php echo substr($course->course_notes, 0,40); ?>...
                                                                 <?php else: ?>
  ...
  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $__currentLoopData = $category->getCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($courses->course_status != "Down"): ?>
                             <div>
                                <div class="uk-card-default uk-card-hover uk-card-small Course-card uk-inline-clip uk-transition-toggle" tabindex="0">


                                  <a href="/view/course/<?php echo e($courses->id); ?>" class="uk-link-reset">
                                      <img src="<?php echo e(asset('img/courses')); ?>/<?php echo e($courses->course_img); ?>" class="course-img">
                                      <div class="uk-card-body">
                                          <h4>
  <?php echo substr($courses->course_title, 0,30); ?>..
  </h4>



                                                           <p><?php if(strlen($courses->course_notes) > '150'): ?>
                                                               <?php echo substr($courses->course_notes, 0,40); ?>...
                                                               <?php else: ?>
                                                               <?php echo $courses->course_notes; ?>

                                                               <?php endif; ?>
                                                           </p>
                                                           <p>
                                                                <strong>Duration:</strong> <?php echo e($courses->course_duration); ?>

                                                           </p>
                                                           <p>
                                                                <strong>Time:</strong> <?php echo e($courses->course_time); ?>
                                          ...
                                          <div class="uk-clearfix">
                                            <div class="uk-float-left">
                                                ...
                                                <a href="/view/course/<?php echo e($courses->id); ?>" class="btn btn-success">View More</a>
                                            </div>
                                          </div>
                                      </div>
                                  </a>
