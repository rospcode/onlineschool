...
Add Course | <?php echo e(auth()->user()->name); ?>
...
<input type="text" name="code" hidden="hidden" id="code" value="<?php echo randomPass(9); ?>"  class="form-control">
                          ...
                          <div class="form-group row"><label class="col-lg-2 col-form-label">Course Title</label>
                              ...
                              <div class="col-lg-10"><input type="text" name="course_title" value="<?php echo e(old('course_title')); ?>" onkeydown="cancel_errors(this.id)" id="course_title" onkeydown="clearmessage()" onclick="enableTxt(this)" placeholder="Course Title" class="form-control">
                          ...
                          <button type="button" class="btn btn-primary">ZAR</button> </span> <input type="text" value="<?php echo e(old('course_cost')); ?>" name="course_cost" id="course_cost" onkeydown="cancel_errors(this.id,this)" class="form-control">
                      </div>
                          ...
                          <div class="form-group row"><label class="col-lg-2 col-form-label">Cost Add Info</label>
                              ...
                              <div class="col-lg-10">
                                ...
                                <div class="input-group m-b">
                                  <input type="text" value="<?php echo e(old('cost_add_notes')); ?>" name="cost_add_notes" id="cost_add_notes" onkeydown="cancel_errors(this.id,this)" class="form-control">
                               </div>
                      <div id="course_add_notes-field" style="color:red;">
                        <?php echo e($errors->has('course_add_notes') ? $errors->first('course_add_notes') : ''); ?>
                          ...
                          <div class="form-group row"><label class="col-lg-2 col-form-label">Course Duration</label>
                              ...
                              <div class="col-lg-10"><input type="text" name="course_duration" value="<?php echo e(old('course_duration')); ?>" onkeydown="cancel_errors(this.id)" id="course_duration" onkeydown="clearmessage()" onclick="enableTxt(this)" id="surname" placeholder="Course Duration" class="form-control">
                          ...
                          <div class="form-group row"><label class="col-lg-2 col-form-label">Course Time</label>
                              ...
                              <div class="col-lg-10">
                                <div class="input-group clockpicker" data-autoclose="true">
                                    <input type="text" class="form-control" onclick="cancel_errors(this.id)" value="<?php echo e(old('course_time')); ?>" name="course_time" id="course_time" value="09:30" >
                          ...
                          <div class="form-group row"><label class="col-lg-2 col-form-label">Course Notes</label>
                              ...
                              <div class="col-lg-10">
                                ...
                                <textarea name="content" class="form-control" onkeypress="cancel_errors(this.id)" id="editor"> <?php echo e(old('content')); ?></textarea>
                          ...
                          <div class="form-group row"><label class="col-lg-2 col-form-label">Course Venue</label>
                              ...
                              <div class="col-lg-10"><input type="text" name="course_venue"  value="<?php echo e(old('course_venue')); ?>" id="course_venue" onkeydown="cancel_errors(this.id)" placeholder="Course Venue" class="form-control">
                          ...
                          <div class="form-group row" id="end_date"><label class="col-lg-2 col-form-label">Course End Date:</label>
                              ...
                              <div class="col-lg-10"><input type="text" name="course_end" id="course_end" onkeydown="cancel_errors(this.id)" placeholder="Select End Date" class="form-control">
                                <div id="course_end-field" style="color:red;">
                                     <?php echo e($errors->has('course_end') ? $errors->first('course_end') : ''); ?>
