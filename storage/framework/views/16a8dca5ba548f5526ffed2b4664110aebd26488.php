              ...
              <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tbody>
                      ...
                      <?php if($user->approved == "no"): ?>
                    <tr class="gradeX">
                        <td><?php echo $count; ?></td>

                        <td><?php echo e($user->getUser->name); ?> <?php echo e($user->getUser->surname); ?>

                        </td>
                        <td>
                             <?php echo e($user->getUser->email); ?>

                        </td>
                        <td>
                             <?php echo e($user->getUser->phone); ?>

                        </td>
                        <td>
                             <?php echo e($user->getUser->id_number); ?>
...
<button class="btn btn-success" onclick="approving('<?php echo e($user->getUser->id); ?>','<?php echo e($user->getUser->name); ?>')">Approve</button>
<a class="btn btn-success" href="/a/user/delete/<?php echo e($user->id); ?>">Remove</a>
