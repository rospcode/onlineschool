...
<head>
    ...
    <link href="<?php echo e(asset('backend/css/plugins/toastr/toastr.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('backend/css/plugins/select2/select2.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('backend/css/plugins/clockpicker/clockpicker.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('backend/css/plugins/switchery/switchery.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <img alt="image" class="rounded-circle" src="<?php echo e(asset('user/')); ?>/<?php echo e(auth()->user()->avatar); ?>"/>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="block m-t-xs font-bold"><?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->surname); ?></span>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm welcome-message" style="color:white;">Welcome <?php echo e(auth()->user()->name); ?>.</span>
                </li>
                <li class="dropdown">
    ...
    <script src="<?php echo e(asset('backend/js/plugins/flot/jquery.flot.symbol.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/js/plugins/flot/jquery.flot.time.js')); ?>"></script>
    ...
    <!-- Jvectormap -->
    <script src="<?php echo e(asset('backend/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>

    <!-- EayPIE -->
    <script src="<?php echo e(asset('backend/js/plugins/easypiechart/jquery.easypiechart.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('backend/js/plugins/sparkline/jquery.sparkline.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('backend/js/plugins/select2/select2.full.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('backend/js/plugins/pdfjs/pdf.js')); ?>"></script>
...
var numbers = 0;
 ...
 var varName = function () {
     if (varCounter == 0) {
         ...
         $.ajax({
    type: "GET",
    url: "<?php echo e(route('ajax-crud')); ?>",
 ...
 function readnotifications(){
      ...
      $.ajax({
    type: "GET",
    url: "<?php echo e(route('readNotifications')); ?>",
    success: function (data) {
...
var varNamess = function () {
    if (varCounterrr == 0) {
        ...
        $.ajax({
   type: "GET",
   url: "<?php echo e(route('getnotcount')); ?>",
   success: function (data) {
...
var numbersi = 0;
 ...
 var varNamei = function () {
     if (varCounteri == 0) {
         ...
         $.ajax({
    type: "GET",
    url: "<?php echo e(route('ajax-crudd')); ?>",
    success: function (data) {
 ...
 //getting number of courses
  $.ajax({
  type: "GET",
  url: "<?php echo e(route('getCoursenum')); ?>",
  success: function (data) {
 ...
 $.ajax({
 type: "GET",
 url: "<?php echo e(route('getCoursenumrequests')); ?>",
 success: function (data) {
 ...
 $.ajax({
 type: "GET",
 url: "<?php echo e(route('getUsernum')); ?>",
 success: function (data) {
 $("#usersnum").html(data)
 },
 error: function (data) {
...
$.ajax({
type: "GET",
url: "<?php echo e(route('getGradnum')); ?>",
success: function (data) {
$("#gradnum").html(data)
},
error: function (data) {
...
$.ajax({
type: "GET",
url: "<?php echo e(route('messagecount')); ?>",
success: function (data) {
