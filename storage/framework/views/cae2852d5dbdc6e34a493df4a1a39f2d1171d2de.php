...
<div class="card">
  <div class="card-body">
      <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> Enrollment History                <a href="" data-toggle="modal" data-target="#myModal2" class="btn btn-outline-primary btn-rounded alignToTitle pull-right"><i class="mdi mdi-plus"></i>Enroll User</a>
  </h4>
  </div> <!-- end card body-->
</div> <!-- end card -->
</div>
...
<div class="wrapper wrapper-content">
              <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tbody>
                      <?php $count = 1; ?>
                      <?php $__currentLoopData = $enroll_ment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enroll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="gradeX">
                        <td><?php echo $count; ?></td>
                        <td><img src="<?php echo e(asset('user/')); ?>/<?php echo e($enroll->getUser->avatar); ?>" alt="" class="img-fluid rounded-circle img-thumbnail" style="width: 10%;" ></td>
                        <td><?php echo e($enroll->getUser->name); ?> <br/> <p style="font-size: 10px; margin-top: 10px;"><span class="badge badge-pill badge-secondary"><?php echo e($enroll->getUser->email); ?></span></p>
                        </td>
                        <td>
                            <a href=""><?php echo e($enroll->note); ?></a>
                        </td>
                        <td>
                          <?php echo e($enroll->created_at); ?>
