...
<section id="gallery-view" style="padding-top: 72px;">
<!-- Page Content -->
...
<div class="mbr-gallery-filter container gallery-filter-active">
    <ul buttons="0">
        ...
        <li><?php echo e($gallery->links()); ?></li>
   ...
   <div class="row">
       ...
       <div class="col-lg-3 col-md-4 col-xs-6 thumb">
           <a href="img/gallery/<?php echo e($img->id); ?>.jpg" class="fancybox" data-fancybox="gallery" rel="ligthbox">
               <img  src="img/gallery/<?php echo e($img->id); ?>.jpg" class="zoom img-fluid " data-fancybox="gallery"  alt="">
