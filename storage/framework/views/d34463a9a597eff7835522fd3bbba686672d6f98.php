...
<div class="wrapper wrapper-content">
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                          <ul>
                           ...
                           <li><?php echo e($enrolled->getCourse->course_title); ?></li>
                        ...
                        <td class="center">
                          ...
                          <?php $__currentLoopData = $user->getGraduate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $graduate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li> <?php echo e($graduate->getCourse->course_title); ?></li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        </td>
                        <td class="center">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="/a/edit_user/<?php echo e($user->id); ?>">Edit</a>
      <a class="dropdown-item" href="/a/profile/<?php echo e($user->id); ?>">View Profile</a>
      <?php if($user->blocked == "yes"): ?>
      <a href="/a/unblock/<?php echo e($user->id); ?>" class="dropdown-item">Unblock User</a>
      <?php else: ?>
      <a href="/a/block/<?php echo e($user->id); ?>" class="dropdown-item">Block User</a>
      <?php endif; ?>
