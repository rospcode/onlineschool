...
margin: 1vh auto;"><div class="alert alert-success">Hey <?php echo e($user->name); ?>, to finish registration please create a password for your account</div></div>
</h1>
<div id="logreg-forms">
...
<?php endif; ?>
             ...
             <div id="finishbutton">
            <button class="btn btn-success btn-block" id="signupbutton" type="button"><i class="fas fa-sign-in-alt"></i>Loggin</button>
          </div>
...
$(function(){
  $("#signupbutton").click(function(){
   ...
   type: "POST",
   url: "<?php echo e(route('finish.signup')); ?>",
