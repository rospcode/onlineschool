     ...
     <div class="card-body">
      ...
      <div class="popup-box chat-popup" id="qnimate">
          <div class="popup-head">
              <div class="popup-head-left pull-left" id="profileimage" style="color: black;"><img src="<?php echo e(asset('img/call-icon.png')); ?>">Ticket Chat</div>
                  ...
                  <div class="msg_history" id="msg_history">
                    ...
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class='incoming_msg'>
                         <div class='incoming_msg_img popup-head-left'> <img src="<?php echo e(asset('img/call-icon.png')); ?>" alt='sunil'> </div>
                       <div class='received_msg'>
                       <div class='received_withd_msg'>
                       <p><?php echo e($message->message); ?></p>
                         <span class='time_date'> <?php echo e($message->created_at); ?></span></div>
                          </div>
                           </div>
                      ...
                      <div class="outgoing_msg">
                          <div class="sent_msg">
                              <p><?php echo e($message->message); ?> <b class='pull-right' style='float: right;'><i class='fas fa-check'></i></b></p><span class="time_date"> <?php echo e($message->created_at); ?></span> </div>
                      </div>
                      <?php endif; ?>
...
$(function(){
  $("#sendmessage").click(function(){
      ...
      if(message != ""){
         ...
         $.ajax({
         type: "POST",
         url: "<?php echo e(route('user.messages')); ?>",
...
var pusher = new Pusher('19ea9d89182fa1adb1f0', {
   ...
   channel.bind('my-event', function(data) {
          ...
          if(<?php echo e(auth()->user()->id); ?> == data.to){
            ...
            if(data.from == "user"){
              msg.append("<div class='outgoing_msg'><div class='sent_msg'><p>"+data.message+" <b class='pull-right' style='float: right;'><i class='fas fa-check'></i></b></p><span class='time_date'> "+strip[0]+"</span> </div></div>");
                ...
                msg.append("<div class='incoming_msg'><div class='incoming_msg_img popup-head-left'> <img src='<?php echo e(asset('img/call-icon.png')); ?>' > </div><div class='received_msg'><div class='received_withd_msg'><p>"+data.message+"</p><span class='time_date'>"+strip[0]+"</span></div></div></div>");
            }
