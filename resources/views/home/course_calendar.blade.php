...
left: 80px;">{{$course->course_title}}</h5>
     ...
     <div class="col-lg-7">
        <ul class="nav-list">
          <li> <a href="" class="active"><strong>Announcements</strong><span class="label label-success float-right" id="usersnum" style="font-size: 11px;background-color: #1c84c6;color: #FFFFFF;border-radius: 50%;width: 24px;position: relative;bottom: 7px;">12</span></a></li>
...
">
       ...
       <div class="course_announ">
         <div class="row">
           <div class="col-lg-6">
               <h6>Course Announcement →  Complete Python Bootcamp: - 2019/09/22 17:15:00</h6>
           </div>
           <div class="col-lg-6">
              <h6 style="float: right;">2 Days ago </h6>
           </div>
         </div>
           <p>Hello this is an Announcement</p>
           <p> https://forms.gle/d59wxqCK5FpVE6sa9</p>
       </div>
