      ...
      <header class="header bg-ui-general">
        ...
        <div class="header-action">
          <nav class="nav">
            ...
            <a class="nav-link  active" href="/u/basic_info">Basic Information</a>
                           ...
                           <div class="list-group list-group-form">
                               ...
                               <div class="list-group-item">
                                   <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-9">
                                           <input type="text" id="fields" name="phone" class="form-control" value="{{ auth()->user()->phone}}" placeholder="Your profile name ...">
                               ...
                               <div class="list-group-item">
                                   <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-9">
                                           <input type="text" id="fields"  class="form-control" readonly="readonly" value="{{ auth()->user()->id_number}}" placeholder="Your profile name ...">
                               ...
                               <div class="list-group-item">
                                   <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-9">
                                           <input type="text" id="fields" readonly="readonly" class="form-control" value="{{ auth()->user()->gender}}" placeholder="Your profile name ...">
                                           <small class="form-text text-muted">Your profile name will be used as part of your public profile URL address.</small>
                                       </div>
                                   </div>
                               </div>
                                   ...
                                   <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-9">
                                         @if(auth()->user()->bio == "")
                                           ...
                                           @else
                                           <textarea rows="3" id="fields" name="bio" class="form-control" >{{ auth()->user()->bio }}</textarea>
                                           @endif
                                       </div>
                                   </div>
                               </div>
                               <div class="list-group-item">
                                   <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-9">
                                           <input type="text" id="fields" readonly="readonly" class="form-control" value="{{ auth()->user()->age}}" placeholder="Your profile name ...">
                                           <small class="form-text text-muted">Your profile name will be used as part of your public profile URL address.</small>
                                       </div>
                                   </div>
                               </div>
                               <div class="list-group-item">
                                   <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-9">
                                           <input type="text" id="fields" name="email" class="form-control" value="{{ auth()->user()->email}}" placeholder="Your profile name ...">
                                           <small class="form-text text-muted">Your profile name will be used as part of your public profile URL address.</small>
                                       </div>
                                   </div>
                               </div>
                               ...
                               <div class="list-group-item">
                                   <div class="custom-control custom-checkbox">
                                       ...
                                       <small class="form-text text-muted" style="left: 10px;
position: relative;
bottom: 4px;">Your current ID Number cannot be changed.</small>
                                   </div>
                               </div>
                               <div class="list-group-item">
                                 @if ($errors->any())
