...
<body>
  ...
  <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      <!-- Brand -->
      <div class="sidenav-header d-flex align-items-center"  style="background-color: #0c1832;">
        <a class="navbar-brand" href="dashboard.html">
          <img src="logo.jpg" class="navbar-brand-img" alt="...">
        </a>
        <div class="ml-auto">
          <!-- Sidenav toggler -->
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="mb-0 text-sm">Sirisha</h4>
                          </div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="default.png" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="{{ asset('hr_loader.png') }}">
                  </span>
                  <div class="media-body ml-2 d-none d-lg-block">
                    <span class="mb-0 text-sm font-weight-bold">Sirisha</span>
                  </div>
                </div>
              </a>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              ...
              <h6 class="h2 d-inline-block mb-0" style="text-transform: uppercase; padding-left: 30px;">Welcome to your Dashboard</h6>
        ...
        <div class="col-xl-8">
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <!-- Title -->
              <h5 class="h3 mb-0">Site Stats</h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <div class="chart">
