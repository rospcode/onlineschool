                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo2.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo2.jpg') }}" class="zoom img-fluid "  alt="">

                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo3.jpg') }}"  class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo3.jpg') }}" class="zoom img-fluid"  alt="">
                                </a>
                            </div>

                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo4.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo4.jpg') }}" class="zoom img-fluid "  alt="">
                                </a>
                            </div>

                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo5.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo5.jpg') }}" class="zoom img-fluid "  alt="">
                                </a>
                            </div>

                             <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo6.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo6.jpg') }}" class="zoom img-fluid "  alt="">
                                </a>
                            </div>

                             <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo7.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo7.jpg') }}" class="zoom img-fluid "  alt="">
                                </a>
                            </div>

                             <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo8.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo8.jpg') }}" class="zoom img-fluid "  alt="">
                                </a>
                            </div>

                             <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{ asset('img/gallery/Photo9.jpg') }}" class="fancybox" rel="ligthbox">
                                    <img  src="{{ asset('img/gallery/Photo9.jpg') }}" class="zoom img-fluid "  alt="">
                                </a>
                            </div>


                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                               <a href="{{ asset('img/gallery/Photo10.jpg') }}" class="fancybox" rel="ligthbox">
                                   <img  src="{{ asset('img/gallery/Photo10.jpg') }}" class="zoom img-fluid "  alt="">
                               </a>
                            </div>

                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                               <a href="{{ asset('img/gallery/Photo11.jpg') }}" class="fancybox" rel="ligthbox">
                                   <img  src="{{ asset('img/gallery/Photo11.jpg') }}" class="zoom img-fluid "  alt="">
                               </a>
                            </div>

                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                               <a href="{{ asset('img/gallery/Photo12.jpg') }}" class="fancybox" rel="ligthbox">
                                   <img  src="{{ asset('img/gallery/Photo12.jpg') }}" class="zoom img-fluid "  alt="">
                               </a>
                            </div>

                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                               <a href="{{ asset('img/gallery/Photo13.jpg') }}" class="fancybox" rel="ligthbox">
                                   <img  src="{{ asset('img/gallery/Photo13.jpg') }}" class="zoom img-fluid "  alt="">
                               </a>
                            </div>
