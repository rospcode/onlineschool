...
@section('page')
Signup Requests | {{ auth()->user()->name }}
@endsection
...
<div class="wrapper wrapper-content">
              <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tbody>
                      <?php $count = 1; ?>
                      @foreach($signuprequests as $requests)
                    <tr class="gradeX">
                        <td><?php echo $count; ?></td>

                        <td>{{ $requests->getUser->name }} {{ $requests->getUser->surname }}
                        </td>
                        <td>
                            {{ $requests->getUser->email }}
                        </td>
                        <td>
                          {{$requests->getUser->>phone }}
                        </td>

                        <td class="center">
                      {{ $requests->getUser->id_number }}
                        </td>
                        <td class="center">
                            {{ $requests->getUser->updated_at }}
                        </td>
                        <td class="center">
                          <div class="btn-group">
