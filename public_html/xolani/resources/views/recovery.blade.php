...
<div class="centralize-wrapper">
    <div class="centralize-inner">
        ...
        <div class="login-box-body">
            ...
            <form method="POST" action="{{ route('account.change_password')}}" class="validator">
              {{ csrf_field() }}
            <div class="form-group has-feedback ">
                <div>
                    <input class="form-control" id="password" name="password" placeholder="Enter Password" data-cval-name="The password field" data-cval-rules="required|escapeInput|password" name="fake_478" type="password">
             ...
             <div class="form-group has-feedback ">
                <div>
                    <input class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password" data-cval-name="The confirm_password field" data-cval-rules="required|escapeInput|password" name="fake_478" type="password">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
                <span class="validation-message cval-error"
                      data-cval-error="fake_478"></span>
...
<div class="alert alert-success">
 ...
 @endif
            ...
            <button class="btn btn-primary btn-flat btn-block form-submission-button" id="login" type="submit" value="login"> Change</button>
            </form>
